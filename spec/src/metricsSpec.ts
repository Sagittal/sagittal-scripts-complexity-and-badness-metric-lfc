...
describe("complexityMetric", (): void => {
    const comma = { vector: [12, -4, 0, -2] } as Comma // N2D3P9 = 10, AAS = 7.357, ATE = 4
    ...
    it("ree", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.REE].metric
    ...
    it("lpe", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.LPE].metric

        const actual = complexityMetric(comma, { a, b, c, sE, tE, sP, tP })

        const expected = 6.04784
        expect(actual).toBeCloseTo(expected)
    })

    it("rpe", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.RPE].metric
    ...
    it("lep", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.LEP].metric
    ...
    it("rep", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.REP].metric
    ...
    it("lpp", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.LPP].metric

        const actual = complexityMetric(comma, { a, b, c, sE, tE, sP, tP })

        const expected = 5.59606
        expect(actual).toBeCloseTo(expected)
    })

    it("rpp", (): void => {
        const complexityMetric =
            COMPLEXITY_METRIC_FAMILIES_WITH_PARAMETERS[ComplexityMetricFamilyId.RPP].metric
